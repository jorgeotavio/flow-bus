...
import { Card, CardBody, Col, Input, Row, UncontrolledCollapse } from 'reactstrap';
...
const BusStopList = () => {
  ...
  return (
    <UncontrolledCollapse  toggler="#toggler" defaultOpen={!!currentBusStop || !!currentItinerary}>
      <div className='mb-3'>
